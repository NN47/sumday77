...
AI_QUOTA_RESERVATION_TTL_SECONDS = int(os.getenv("AI_QUOTA_RESERVATION_TTL_SECONDS", "180"))
...
AI_IMAGE_ATTEMPT_LIMIT_PER_DAY = int(os.getenv("AI_IMAGE_ATTEMPT_LIMIT_PER_DAY", "20"))
