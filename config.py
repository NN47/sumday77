...
# OpenAI vision pool and its deliberately conservative complimentary daily budget.
# OpenAI quota days are UTC calendar days (03:00–02:59:59 MSK).
OPENAI_VISION_MODEL = "gpt-5.4-2026-03-05"
OPENAI_TEXT_MODEL = os.getenv("OPENAI_TEXT_MODEL", OPENAI_VISION_MODEL)
OPENAI_DAILY_TOKEN_LIMIT = 248_000
OPENAI_LABEL_TOKEN_RESERVE = 3_000
OPENAI_FOOD_PHOTO_TOKEN_RESERVE = 3_500
OPENAI_MEAL_TEXT_TOKEN_RESERVE = int(os.getenv("OPENAI_MEAL_TEXT_TOKEN_RESERVE", "3000"))
OPENAI_MEAL_COMMENT_TOKEN_RESERVE = int(os.getenv("OPENAI_MEAL_COMMENT_TOKEN_RESERVE", "2500"))
OPENAI_DAILY_ANALYSIS_TOKEN_RESERVE = int(os.getenv("OPENAI_DAILY_ANALYSIS_TOKEN_RESERVE", "8000"))
...
AI_MEAL_COMMENT_ATTEMPT_LIMIT_PER_DAY = int(
    os.getenv("AI_MEAL_COMMENT_ATTEMPT_LIMIT_PER_DAY", "17")
)
AI_CHAT_LIMIT_PER_DAY = int(os.getenv("AI_CHAT_LIMIT_PER_DAY", "10"))
AI_CHAT_ATTEMPT_LIMIT_PER_DAY = int(os.getenv("AI_CHAT_ATTEMPT_LIMIT_PER_DAY", "15"))
