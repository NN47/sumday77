...
Пользователь только что завершил один приём пищи. Твоя задача — дать один короткий, живой и персональный комментарий.
...
Комментарий должен ощущаться написанным специально для этого приёма пищи.
