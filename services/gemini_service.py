  ...
  "dishes": [
    {
      ...
      "confidence": "medium",
      "ingredients": [
        {"name": "название ингредиента", "grams": 123, "kcal": 123, "protein": 1.2, "fat": 3.4, "carbs": 5.6}
      ]
    }
  ]
}
...
- гарнир и компоненты одной тарелки группируй как одно блюдо, если они выглядят как единая порция;
...
- КБЖУ для ingredients указывай за оценённую массу продукта, не на 100 г;
