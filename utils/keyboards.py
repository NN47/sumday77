...
ACTIVITY_CATEGORIES = {
    ...
    "bodyweight": {"title": "💪 Собственный вес", "activities": [
        "Отжимания", "Подтягивания", "Приседания", "Планка", "Скручивания", "Берпи",
        "Наклон с отведением таза", "Гиперэкстензия",
    ]},
    "gym": {"title": "🏋️ Свободные веса и тренажёры", "activities": [
        "Армейский жим с гантелями", "Становая тяга", "Тяга верхнего блока",
        ...
        "Румынская тяга", "Сгибание ног в тренажёре",
